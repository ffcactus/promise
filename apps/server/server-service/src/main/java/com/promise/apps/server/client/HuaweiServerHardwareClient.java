...
import com.promise.apps.server.client.dto.GetChassisResponse;
import com.promise.apps.server.client.dto.GetComputerSystemResponse;
import com.promise.apps.server.client.dto.GetProcessorResponse;
...
//    }
    ...
    @Override
    public @NotNull
    ManagerResource getManagerResource() {
    ...
    @Override
    public @NotNull
    BoardResource getBoardResource() {
    ...
    @Override
    public @NotNull
    AdapterResource getAdapterResource() {
    ...
    @Override
    public @NotNull
    PowerResource getPowerResource() {
    ...
    @Override
    public @NotNull
    ThermalResource getThermalResource() {
    ...
    @Override
    public @NotNull
    FirmwareResource getFirmwareResource() {
